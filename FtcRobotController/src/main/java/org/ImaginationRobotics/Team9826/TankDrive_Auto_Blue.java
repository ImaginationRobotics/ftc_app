 ...
 * TankDrive_Auto_Blue
 *
 * An autonomous for the Blue side of the field.
 */
public class TankDrive_Auto_Blue extends OpMode {
    Robot9826 robot;
    private int state;
    private long lastStateChange;


    public TankDrive_Auto_Blue(){
    }
    ...
    public void loop(){
        switch(state){
            ...
            case 3:{
                robot.run_using_encoders();
                robot.drive(0.5, Robot9826.DriveDirection.right);
